...
INSERT INTO rss_links (link, title, pub_date) VALUES 
    ...
    ('https://blog.example.com/post1', 'ブログ記事1', '2025-01-01 12:00:00+00:00'),
    ('https://tech.example.com/update1', '技術更新1', '2025-01-01 13:00:00+00:00'),
    ('https://news.example.com/breaking', '速報記事', '2025-01-01 14:00:00+00:00'),
    
    -- 既に処理済みになる予定のURL（3件）
    ('https://old.example.com/processed1', '処理済み記事1', '2024-12-25 10:00:00+00:00'),
    ('https://old.example.com/processed2', '処理済み記事2', '2024-12-25 11:00:00+00:00'),
    ('https://archive.example.com/old', 'アーカイブ記事', '2024-12-20 15:00:00+00:00');
