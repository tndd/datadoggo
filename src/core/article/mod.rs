...
pub use model::{
    ...
    search_articles, Article, ArticleInfo, ArticleQuery, ArticleStatus,
};

// service.rsから（内部実装、最小限のみ公開）
pub use service::{
    fetch_and_store_article, fetch_and_store_article_with_client, get_article_content_for_storage,
    get_article_content_for_storage_with_client, search_backlog_article_info,
    store_article_content, ArticleStorageData,
};
